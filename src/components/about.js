    ...
    return (
        <section id="about" className="section-padding">
            <div className="about-content-wrapper">
                <FadeInSection>
                    <p style={{ lineHeight: "2em" }}>I am a Junior Web and Software Developer based in the South West of England. I specialise in Full-Stack Web Development.
                        I graduated with a First-Class Honours BSc degree in Applied Computing from UWE Bristol in 2022 and plan on going back to University to achieve a Masters
